...
export const addProjectFromUrl = (data) => {
    return axios.put("/api/project/createFromUrl", data);
}
...
export const updateSecondaryImage = (data) => {
    return axios.post("/api/project/updateSecondaryImage", data);
}
